...
* [Install Builder on-prem authenticating with Chef Automate](/on-prem-docs/builder-automate.md)
* [Install Builder on-prem authenticating with another OAuth service](/on-prem-docs/builder-oauth.md)
